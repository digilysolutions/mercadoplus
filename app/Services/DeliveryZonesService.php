...
class DeliveryZonesService
{
    ...
    {
        $this->baseUrl = 'https://api.digilysolutions.com/api/deliveryZones';
    }
    ...
    public function createDeliveryZone($data)
    {
    ...
    public function showDeliveryZone($id)
    {
    ...
    public function updateDeliveryZone($id, $data)
    {
