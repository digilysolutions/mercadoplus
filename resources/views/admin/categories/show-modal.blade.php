<div class="modal fade" id="categoryShowModal{{ $category['id'] }}" tabindex="-1" role="dialog"
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-3">
                            <div class="profile-img position-relative">
                                <img src="{{ $category['path_image'] }}" class="img-fluid rounded avatar-110"
                                    alt="profile-image">
                            </div>
                            <div class="ml-3">
                        ...
                        <p>
                            ...
                            <ul>
                                @foreach ($formattedExchangeRates as $currency => $rate)
                                    <li>{{ $currency }}: {{ $rate }}</li>
                                @endforeach
                            </ul>
