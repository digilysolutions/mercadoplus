<div class="modal fade" id="new-tag" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="card-title">Añadir nueva etiqueta</h4>
                              ...
                              <div class="col-md-12">
                                  <div class="form-group">
                                      ...
                                      <input id="name" name="name" type="text" class="form-control"
                                          placeholder="El nombre de la etiqueta" required>
