<div class="modal fade" id="edit-business" tabindex="-1" role="dialog" aria-modal="true">
    <div class="modal-dialog modal-lg">
        <form method="POST" action="{{ route('business.update', ['id' => $business['id']]) }}" id="editCategoryForm"
                                                            ...
                                                            <div class="card card-block card-stretch">
                                                                <div class="card-body p-3">
                                                                    <div class="row align-items-center py-2">
                                                                        <div class="col-md-6">
                                                                            <label>País:
                                                                                {{ $business['country']['name'] }}</label>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                            <label>Municipio:
                                                                                {{ $business['contact_location']['city'] }}</label>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text"
                                                                                    id="location_name"
                                                                                    name="location_name"
                                                                                    value="{{ $business['contact_location']['name'] }}"
                                                                                    class="form-control">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" id="zip_code"
                                                                                    name="zip_code"
                                                                                    value="{{ $business['contact_location']['zip_code'] }}"
                                                                                    class="form-control">
                                                                                <div class="help-block with-errors">
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" id="address"
                                                                                    name="address"
                                                                                    value="{{ $business['contact_location']['address'] }}"
                                                                                    class="form-control">
                                                                                <div class="help-block with-errors">
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" id="landmark"
                                                                                    name="landmark"
                                                                                    value="{{ $business['contact_location']['landmark'] }}"
                                                                                    class="form-control">
                                                                                <div class="help-block with-errors">
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <div class="form-group">
                                                                                <label>Descripción</label>
                                                                                <textarea class="form-control" id="location_description" name="location_description" rows="4">{{ $business['contact_location']['description'] }}</textarea>
                                                                            </div>
                                                                        </div>
                                                ...
                                                <div class="card-body p-3">
                                                    <div class="row align-items-center text-center">
                                                        @foreach ($countries_currencies as $countrycurrency)
                                                            <div class="profile-info col-xl-3 col-lg-6">
                                                                ...
                                                                <div class="">
                                                                    ...
                                                                    <a class="badge bg-success mr-2"
                                                                        ...
                                                                        href="#"><i
                                                                            class="ri-pencil-line mr-0 btn-edit"
                                                                            data-toggle="modal"
                                                            ...
                                                            <!---- Modl para eliminar tasa de cambio -->
