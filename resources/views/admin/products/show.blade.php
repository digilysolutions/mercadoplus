                ...
                <div class="card car-transparent">
                    <div class="card-body p-0">
                        <div class="profile-image position-relative">
                            <img src="/img/upload/show-product.webp" class="img-fluid rounded w-100" alt="profile-image">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card card-block card-stretch card-height">
                    <div class="card-body">
                        ...
                        <div class="estrellas align-items-center justify-content-center text-center" id="estrellas">
                            @for ($index = 0; $index < $averageRating; $index++)
                    ...
                    <div class="card-body">
                        <ul class="d-flex nav nav-pills mb-3 text-center profile-tab" id="profile-pills-tab" role="tablist">
                            ...
                            @if (isset($product['tags']) &&
                                    $product['tags'] != null &&
                                    isset($product['currencies']) &&
                                    $product['currencies'] != null &&
                                    isset($product['enable_delivery']) &&
                                    $product['enable_delivery'] != null)
                                <li class="nav-item">
                        ...
                        <div class="profile-content tab-content ">
                            ...
                            <div id="profile2" class="tab-pane fade">
                                <div class="row">
                                    @if ($attributeTerms != null && count($attributeTerms) > 0)
                                        <div class="col-lg-4">

                                            @foreach ($attributeTerms as $attributeTerm)
                                                <div class="card card-block card-stretch mb-1">
                                                    <div class="card-header px-4">
                                                        <div class="header-title">
                                                            <h4 class="card-title">{{ $attributeTerm['attribute_name'] }}
                                                            </h4>
                                                        </div>
                                                    </div>
                                                    <div class="card-body p-4">
                                                        @foreach ($attributeTerm['terms'] as $term)
                                    ...
                                    @if (isset($product['currencies']) && $product['currencies'] != null)
                                        <div class="col-lg-6 ">
                                            <div class="ml-3">
                                                ...
                                                @foreach ($product['currencies'] as $currencie)
                                                    <span class="mt-2 badge badge-primary">{{ $currencie['currency'] }}
                                                    </span>
                                                @endforeach
                                            </div>
                                            ...
                                            <div class="ml-3">
                                                ...
                                                @foreach ($product['deliveryZones'] as $deliveryZone)
                                                    <button type="button" class="btn mb-1 bg-primary-light">
                                                        {{ $deliveryZone['location'] }} <span
                                                            class="badge badge-primary ml-2">${{ $deliveryZone['price'] }}</span>
                                                    </button>
                                                @endforeach
