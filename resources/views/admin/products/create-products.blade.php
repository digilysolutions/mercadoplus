...
@section('content-admin')
                            ...
                            <div class="card-body">
                                                    ...
                                                    <div class="iq-email-listbox">
                                                        <div class="tab-content">
                                                            ...
                                                            <div class="tab-pane fade active show" id="mail-starred"
                                                                role="tabpanel">
                                                                <div class="col-md-12">
                                                                    <div class="checkbox mr-2 pt-2"  >
                                                                        <label><input class="mr-2" id="is_activated" name="is_activated" 
                                                                                type="checkbox" checked>Producto Activado</label>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-12">
                                                                            ...
                                                                            <select id="brand" name="brand_id"
                                                                                ...
                                                                                @foreach ($brands as $brand)
                                                                                    <option value="{{ $brand['id'] }}"
                                                                                        data-models="{{ json_encode($brand['models']) }}">
                                                                                        {{ $brand['name'] }}
                                                                                    </option>
                                                                                @endforeach
                                                                            </select>
                                                            ...
                                                            <div class="tab-pane fade" id="mail-important"
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <select id="attribute" class="form-control" disabled>
                                                                                <option value="" disabled selected>
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <div class="form-group row">
                                                                        <label
                                                                            class="control-label col-sm-4 align-self-center"
                                                                            for="end-date">Fecha de expiración</label>
                                                                        <div class="col-sm-8">
                                                                            <input type="date" class="form-control"
                                                                                id="expiration_date"
                                                                                name="expiration_date" min="">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-6">
                                                                            ...
                                                                            <input type="text" class="form-control"
                                                                                ...
                                                                                name="expiry_period_type" disabled>
                                                                                  <!-- Input oculto para enviar el valor -->
                                                                            <input type="hidden"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="description_small" id="description_small" rows="3"></textarea>
                                            ...
                                            <tbody>
                                                ...
                                                <tr data-id="2" data-parent="1" data-level="2" style="">
                                                    <td>
                                                        ...
                                                        <div id="etiquetas-seleccionadas"></div>
                                                        <!-- Campo oculto que almacenará la cadena de etiquetas seleccionadas -->
                                                        ...
                                                        @foreach ($categories as $category)
                                                            <div class="checkbox">
                                                                <input type="checkbox" class="checkbox-input"
                                                                    ...
                                                                    value="{{ $category['id'] }}">
                                                                <label for="checkbox1">{{ $category['name'] }}</label>
                                                            </div>
                                                        @endforeach
                                                        <div id="categories-list"></div>

                                                        <a href="#" data-toggle="modal"
                                                            data-target="#new-category-product">+ Añadir nueva categoría
                                                        </a>
                                                    </td>
    ...
    @include('admin.products.add-modal-product')
@endsection
...
@section('js')
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#attribute').change(function() {
                ...
                if (attributeId) {
                    ...
                    $.ajax({
                        url: '/admin/terms/attribute/json/' + attributeId,
                        method: 'GET',
                        dataType: 'json',
                        success: function(data) {
                            // Llenar el objeto termNames
                            termNames
                                = {}; // Reinicia el objeto cada vez que cambias de atributo
            ...
            $('#add-terms').click(function() {
                ...
                `;
                    $('#terms_id').val(termsId.join(
                        ',')); // Unir los IDs en una cadena separada por comas
                    // Deshabilitar el atributo seleccionado
                    // Limpiar terms select
                    $('#terms').empty();
        ...
        `);
                ...
                $('#tag_id').val(etiquetasSeleccionadas.map(e => e.id).join(','));
            }
            ...
            $('#add-button').on('click', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (!etiquetasSeleccionadas.includes(tag.name)) {
                            etiquetasSeleccionadas.push({
                                id: tag.id,
                                name: tag.name
                            });
        ...
        $(document).ready(function() {
            ...
            const addModelEndpoint = '/admin/add/models'; // Cambia por la URL correcta para agregar un modelo
            ...
            $('#addModelBand').on('click', function(e) {
                ...
                $.ajax({
                    url: addModelEndpoint,
                    type: 'POST',
                    data: {
                        name: newModelName,
                        brand_id: brandId,
                        _token: $('meta[name="csrf-token"]').attr(
                            'content') // Asegúrate de tener el token CSRF en el meta
                    },
                    success: function(data) { // Cierra el modal
                        ...
                        // Opción para limpiar el input después de añadir un modelo
                        $('#newModel').val(''); // Limpia el campo de nuevo modelo
                    },
